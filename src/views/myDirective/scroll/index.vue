<template>
  <div id="scrollTo-container" class="scrollTo-container">
    <h2>Adds a directive that listens for click events and scrolls to elements</h2>
    <ul class="button">
      <!-- 第一种方式滚动,requestAnimationFrame -->
      <li>
        <el-button v-scroll-to="options1" :class="{active:active===1}">scrollTo1</el-button>
      </li>
      <li>
        <el-button v-scroll-to="options2" :class="{active:active===2}">scrollTo2</el-button>
      </li>
      <li>
        <el-button v-scroll-to="options3" :class="{active:active===3}" @click="clickHandler(3)">scrollTo3</el-button>
      </li>
    </ul>
